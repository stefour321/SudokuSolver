...
Description: 
This is the implementation code file for the SudokuSolver problem. 
This file is referenced from the Sudoku Solver code from Geeks
for Geeks. This code contains the neccessary functions to solve
a sudoku puzzle.

---Sudoku Code copied from Geeks for Geeks: https://www.geeksforgeeks.org/sudoku-backtracking-7/ ---
*/ 
using namespace std;
#include <iostream>
#define N 9
...
bool solveSudoku(int grid[N][N], int row, int col)
{
    ...
    for (int num = 1; num <= N; num++)
    {
        ...
        // was wrong , and we go for next assumption with diff num value
        grid[row][col] = 0;
    }
    return false;
}
/* ---- Referenced sudoku code ends here ---- */